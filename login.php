<!DOCTYPE html>
  <html>
    <head>
      ...
      <title>Registro de Busqedas Laborales</title>
   </head>
<body>
...
<div class="container">
  <div class="row primera">
    <div class="col s12">
      <h1 class="center-align" style="color: #295E94">Acceso a las busquedas laborales registradas</h1>
    </div>
  </div>
  <div class="row">
  
    <div class=".col s4 center-block">
        <form action="accessRegSearch.php" method="post"> 
